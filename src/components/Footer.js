  ...
  return (
    <FooterContainer className='main-footer'>
        ...
        <div className='container'>
            <div className='row '>
                {/* column 1 */}
                <div className='head5 col-md-3 col-sm-6'>
                    <h5 className='head1 text-blue text-uppercase'>MERCY</h5>
                    <ul className='list-unstyled'>
                        <li><a href='/'><p className='paragraph1 text-white text-capitalize'>empowering youth <br/>entrepreneurs from<br/>mombasa</p></a></li>
                    </ul>
                </div>
                {/* column 2 */}
                <div className='head4 col-md-3 col-sm-6'>
            ...
            <div className='footer-bottom'>
                <p className='text-xs-center'>
                    Copyright {new Date().getFullYear()} GOYN MERCY <span> Privacy Policy</span>
                </p>
            </div>
            </div>
        </div>
